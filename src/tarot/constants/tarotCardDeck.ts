...
const majorArcanaArray = Object.values(majorArcanaObjects).map(({ name, id, imgSrc, alt }) => ({
  name,
  id,
  imgSrc,
  alt,
...
const swordArray = Object.values(swordObjects).map(({ name, id, imgSrc, alt }) => ({
  name,
  id,
  imgSrc,
  alt,
...
const pentacleArray = Object.values(pentacleObjects).map(({ name, id, imgSrc, alt }) => ({
  name,
  id,
  imgSrc,
  alt,
